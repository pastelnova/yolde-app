...
export const issues: Issue[] = [
  ...
  },
  {
    ...
    description: 'Ship the new hero, pricing, and testimonials sections.',
  ...
  },
  {
    id: 'i-mkt-22',
    key: 'MKT-22',
    title: 'Write Q1 blog post backlog',
    description: 'Outline and draft the next five product blog posts.',
    projectId: 'p-marketing',
    typeId: 't-task',
    status: 'todo',
    priority: 'medium',
  ...
  },
  {
    id: 'i-int-07',
    key: 'INT-07',
    title: 'Internal feedback bot in Slack',
    description: 'Forward customer feedback from Intercom to #feedback.',
  ...
  },
  {
    id: 'i-int-08',
    key: 'INT-08',
    title: 'Migrate logs to OpenSearch',
    description: 'Move app logs off CloudWatch into the new OpenSearch cluster.',
    projectId: 'p-internal',
    typeId: 't-chore',
    status: 'backlog',
    priority: 'low',
